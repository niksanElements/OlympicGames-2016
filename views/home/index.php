<div class="wrapper col4">
    <div id="container">
        <div id="content">
            <div id="featured_post"><img src="../../content/images/demo/620x270.gif" alt="" />
              <?php //echo $this->model->getHomeContentUser(); ?>
            ...
            <div id="hpage_latest">
                <ul>
                    <li><img src="../../content/images/demo/190x80.gif" alt="" />
                    ...
                    <li class="last"><img src="../../content/images/demo/190x80.gif" alt="" />
                        <p>Nullamlacus dui ipsum conseqlo borttis non euisque morbipen a sdapibulum orna.</p>
                        <p>Urnau ltrices quis curabitur pha sellent esque congue magnisve stib ulum quismodo nulla et.</p>
                        <p class="readmore"><a href="#">Continue Reading &raquo;</a></p>
                    </li>
        ...
        <div id="column">
            <ul id="latestnews">
                <li><img src="../../content/images/demo/80x80.gif" alt="" />
                ...
                <li class="last"><img src="../../content/images/demo/80x80.gif" alt="" />
                    <p><strong><a href="#">Indonectetus facilis leo.</a></strong> Nullamlacus dui ipsum cons eque lobor ttis non euis que morbi penas dapi bulum orna. Urnaul trices quis curabitur.</p>
                </li>
            </ul>
        </div>
...
<div class="wrapper col5">
    <div class="gallery">
        ...
        <ul>
            <li><a href="#"><img src="../../content/images/demo/174x174.gif" alt="" /></a></li>
            <li><a href="#"><img src="../../content/images/demo/174x174.gif" alt="" /></a></li>
            <li><a href="#"><img src="../../content/images/demo/174x174.gif" alt="" /></a></li>
            <li><a href="#"><img src="../../content/images/demo/174x174.gif" alt="" /></a></li>
            <li class="last"><a href="#"><img src="../../content/images/demo/174x174.gif" alt="" /></a></li>
            <li><a href="#"><img src="../../content/images/demo/174x174.gif" alt="" /></a></li>
            <li><a href="#"><img src="../../content/images/demo/174x174.gif" alt="" /></a></li>
            <li><a href="#"><img src="../../content/images/demo/174x174.gif" alt="" /></a></li>
            <li><a href="#"><img src="../../content/images/demo/174x174.gif" alt="" /></a></li>
...
<div class="wrapper col6">
    <div id="footer">
        ...
        <div class="footbox flickr">
            ...
            <ul>
                <li><a href="#"><img src="../../content/images/demo/80x80.gif" alt="" /></a></li>
                <li><a href="#"><img src="../../content/images/demo/80x80.gif" alt="" /></a></li>
                <li><a href="#"><img src="../../content/images/demo/80x80.gif" alt="" /></a></li>
                <li><a href="#"><img src="../../content/images/demo/80x80.gif" alt="" /></a></li>
                <li><a href="#"><img src="../../content/images/demo/80x80.gif" alt="" /></a></li>
        ...
        <div class="footbox banners last">
            ...
            <ul>
                <li><a href="#"><img src="../../content/images/demo/200x150.gif" alt="" /></a></li>
                <li><a href="#"><img src="../../content/images/demo/200x150.gif" alt="" /></a></li>
            </ul>
        </div>
        <br class="clear" />
